...
$reportBuySql = "SELECT * FROM sell_history WHERE date = '$selecteddate'";
...
<br>
            ...
            <h1 style="text-align: center;" class="">Fahiha's Bakery</h1>
            <h5 style="text-align: center;" class="">Sell list on <?php echo $selecteddate;?> </h5>

...
$flourq = $_SESSION['flourq'];
$eggq = $_SESSION['eggq'];
$oilq = $_SESSION['oilq'];
$bpowderq = $_SESSION['bpowderq'];





$stmt = $conn->prepare("insert into ordertable(totalcost, flourq, eggq,oilq, bpowderq, time)
values($totalcost,$flourq,$eggq, $oilq, $bpowderq)");

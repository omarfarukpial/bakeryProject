...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="menu text-right">
                    <ul>
                        ...
                        <li>
                            <a href="foodform.php">Create Foods</a>
                        </li>
                        <li>
                            <a href="#">Contact</a>
                        </li>
        ...
        <div class="inform">
            <form action="foodcost.php" method = "post">
                <label for="flourq">Flour quantity</label>
                <input type="text" id="flourq" name="flourq" placeholder="Flour quantity in kg...">

                <label for="eggq">Egg</label>
                <input type="text" id="eggq" name="eggq" placeholder="Egg quantity in piece...">
               

                <label for="oilq">Oil</label>
                <input type="text" id="oilq" name="oilq" placeholder="Oil quantity in liter...">

                <label for="bpowderq">Baking powder</label>
                <input type="text" id="bpowderq" name="bpowderq" placeholder="Baking powder quantity in kg...">

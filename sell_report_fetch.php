...
$reportBuySql = "SELECT * FROM sell_history WHERE date BETWEEN '$stime' AND '$etime'";
...
<br>
            ...
            <h5 style="text-align: center;" class="">Sell list between <?php echo $stime;?> and <?php echo $etime;?> </h5>

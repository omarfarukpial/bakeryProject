...
$reportBuySql = "SELECT * FROM purchase_history WHERE DATE_FORMAT(date, '%Y') = '$selectedyear' ";
...
$reportSellSql = "SELECT * FROM sell_history WHERE DATE_FORMAT(date, '%Y') = '$selectedyear' ";

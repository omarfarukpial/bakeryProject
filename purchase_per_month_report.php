...
$reportBuySql = "SELECT * FROM purchase_history WHERE DATE_FORMAT(date, '%Y-%m') = '$selectedmonth' ";
...
<br>
            ...
            <h5 style="text-align: center;" class="">Purchase list is <?php echo $selectedmonth;?></h5>
